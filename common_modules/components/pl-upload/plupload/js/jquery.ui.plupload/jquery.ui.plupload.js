...
$.widget("ui.plupload", {
	...
	*/
	...
	/**
	Display a messageBox in notification area.

	@method notify
	@param {Enum} type Type of the messageBox, either `error` or `info`
	@param {String} message The text messageBox to display.
	*/
