module.exports = {
  ...
  address: {
    ...
    '新疆维吾尔自治区': {
      ...
      "乌鲁木齐市": ["市辖区","米东区","经济技术开发区（头屯河区）","高新技术产业开发区（新市区）","天山区","沙依巴克区","水磨沟区","达坂城区","乌鲁木齐县"],
      "阿勒泰地区": ["阿勒泰地直","阿勒泰市","布尔津县","富蕴县","福海县","哈巴河县","青河县","吉木乃县","喀纳斯景区管理委员会"],
      "塔城地区": ["塔城地直","塔城市","乌苏市","额敏县","沙湾县","托里县","裕民县","和布克赛尔蒙古自治县"],
      "哈密市": ["哈密市直","伊州区","伊吾县","巴里坤县"],
      "克拉玛依市": ["市辖区","独山子区","克拉玛依区","白碱滩区","乌尔禾区"],
      "和田地区": ["和田地直","和田市","和田县","墨玉县","皮山县","洛浦县","策勒县","于田县","民丰县"],
      "阿克苏地区": ["阿克苏地直","阿克苏市","温宿县","库车县","沙雅县","新和县","拜城县","乌什县","阿瓦提县","柯坪县"],
      "吐鲁番市": ["吐鲁番市直","高昌区","鄯善县","托克逊县"],
      "伊犁哈萨克自治州": ["伊犁州州直","察布查尔锡伯自治县","特克斯县","昭苏县","新源县","巩留县","霍城县","伊宁县","奎屯市","伊宁市","尼勒克县","霍尔果斯市"],
      "昌吉回族自治州": ["昌吉州州直","昌吉市","阜康市","呼图壁县","玛纳斯县","奇台县","吉木萨尔县","木垒县"],
      "喀什地区": ["喀什地直","喀什市","塔什库尔干塔吉克自治县","巴楚县","伽师县","岳普湖县","麦盖提县","叶城县","莎车县","泽普县","英吉沙县","疏勒县","疏附县"],
      "博尔塔拉蒙古自治州": ["博州州直","博乐市","精河县","温泉县","阿拉山口市"],
      "巴音郭楞蒙古自治州": ["巴州州直","库尔勒市","博湖县","和硕县","和静县","焉耆回族自治县","且末县","若羌县","尉犁县","轮台县","库尔勒经济技术开发区"],
      "克孜勒苏柯尔克孜自治州": ["克州州直","阿图什市","阿克陶县","阿合奇县","乌恰县"],
      "石河子市": ["市辖区"]
    },
    '河北省': {
