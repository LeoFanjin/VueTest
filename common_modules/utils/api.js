...
const i18n = require('../../src/ap-base/lang')[`${G.lang}`];
...
const API = {
  basePost: function (opt) {
    ...
    let queueName = opt.queueName == null ? opt.url + JSON.stringify(opt.data) : opt.queueName;
    if (queueName) {
  ...
  post: function (opt) {
    ...
    return pro.then(function (res) { //请求成功返回数据
